...
/*!50001 VIEW `yearly_sales_view` AS select year(`st`.`transaction_date`) AS `sale_year`,`p`.`product_id` AS `product_id`,`p`.`name` AS `product_name`,`pv`.`variant_id` AS `variant_id`,`s`.`size` AS `size`,`pv`.`color` AS `color`,coalesce(sum(`ti`.`quantity`),0) AS `total_quantity_sold`,coalesce(sum((`ti`.`quantity` * `ti`.`price`)),0) AS `total_sales`,`pv`.`quantity` AS `available_quantity` from ((((`sales_transactions` `st` join `transaction_items` `ti` on((`st`.`transaction_id` = `ti`.`transaction_id`))) join `productvariant` `pv` on((`ti`.`product_id` = `pv`.`variant_id`))) join `product` `p` on((`pv`.`product_id` = `p`.`product_id`))) join `size` `s` on((`s`.`size_id` = `pv`.`size_id`))) where (`st`.`transaction_date` between '2024-05-02' and '2024-10-15') group by `sale_year`,`p`.`product_id`,`pv`.`variant_id`,`pv`.`size_id`,`pv`.`color` order by `sale_year` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`swen3920`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `inventory_metrics_view` AS select `bi`.`product_name` AS `product_name`,`bi`.`product_id` AS `product_id`,`bi`.`variant_id` AS `variant_id`,`pv`.`color` AS `color`,`s`.`size` AS `size`,((`bi`.`beginning_inventory` + `ei`.`ending_inventory`) / 2) AS `avg_inventory_level`,((coalesce(sum(`ds`.`total_quantity_sold`),0) / ((`bi`.`beginning_inventory` + `ei`.`ending_inventory`) / 2)) * 100) AS `turnover_rate`,((coalesce(sum(`ds`.`total_quantity_sold`),0) / `bi`.`beginning_inventory`) * 100) AS `sell_through_rate` from ((((`beginning_inventory_view` `bi` join `ending_inventory_view` `ei` on((`bi`.`variant_id` = `ei`.`variant_id`))) left join `daily_sales_view` `ds` on((`bi`.`variant_id` = `ds`.`variant_id`))) join `productvariant` `pv` on((`bi`.`variant_id` = `pv`.`variant_id`))) join `size` `s` on((`s`.`size_id` = `pv`.`size_id`))) group by `bi`.`product_id`,`bi`.`variant_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`swen3920`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `daily_sales_view` AS select cast(`st`.`transaction_date` as date) AS `sale_date`,`p`.`product_id` AS `product_id`,`p`.`name` AS `product_name`,`pv`.`variant_id` AS `variant_id`,`s`.`size` AS `size`,`pv`.`color` AS `color`,coalesce(sum(`ti`.`quantity`),0) AS `total_quantity_sold`,coalesce(sum((`ti`.`quantity` * `ti`.`price`)),0) AS `total_sales`,`pv`.`quantity` AS `available_quantity` from ((((`sales_transactions` `st` join `transaction_items` `ti` on((`st`.`transaction_id` = `ti`.`transaction_id`))) join `productvariant` `pv` on((`ti`.`product_id` = `pv`.`variant_id`))) join `product` `p` on((`pv`.`product_id` = `p`.`product_id`))) join `size` `s` on((`s`.`size_id` = `pv`.`size_id`))) where (`st`.`transaction_date` between '2024-05-02' and '2024-10-15') group by `sale_date`,`p`.`product_id`,`pv`.`variant_id`,`pv`.`size_id`,`pv`.`color` order by `sale_date` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`swen3920`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `ending_inventory_view` AS select `pv`.`product_id` AS `product_id`,`pv`.`variant_id` AS `variant_id`,sum(`pv`.`quantity`) AS `ending_inventory` from `productvariant` `pv` where (`pv`.`date_added` <= '2024-10-15') group by `pv`.`product_id`,`pv`.`variant_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`swen3920`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `beginning_inventory_view` AS select `r`.`variant_id` AS `variant_id`,`pv`.`variant_id` AS `product_id`,`p`.`name` AS `product_name`,(sum(`r`.`quantity`) - coalesce(sum(`ti`.`quantity`),0)) AS `beginning_inventory` from (((`restock` `r` left join (select `ti`.`product_id` AS `product_id`,`pv`.`variant_id` AS `variant_id`,sum(`ti`.`quantity`) AS `quantity` from ((`transaction_items` `ti` join `productvariant` `pv` on((`ti`.`product_id` = `pv`.`variant_id`))) join `sales_transactions` `st` on((`ti`.`transaction_id` = `st`.`transaction_id`))) where (`st`.`transaction_date` < '2024-05-02') group by `ti`.`product_id`,`pv`.`variant_id`) `ti` on(((`r`.`variant_id` = `ti`.`product_id`) and (`r`.`variant_id` = `ti`.`variant_id`)))) join `productvariant` `pv` on((`r`.`variant_id` = `pv`.`variant_id`))) join `product` `p` on((`p`.`product_id` = `pv`.`product_id`))) where (`r`.`restock_date` < '2024-05-02') group by `r`.`variant_id`,`pv`.`variant_id`,`product_name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`swen3920`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `weekly_sales_view` AS select year(`st`.`transaction_date`) AS `sale_year`,week(`st`.`transaction_date`,0) AS `sale_week`,`p`.`product_id` AS `product_id`,`p`.`name` AS `product_name`,`pv`.`variant_id` AS `variant_id`,`s`.`size` AS `size`,`pv`.`color` AS `color`,coalesce(sum(`ti`.`quantity`),0) AS `total_quantity_sold`,coalesce(sum((`ti`.`quantity` * `ti`.`price`)),0) AS `total_sales`,`pv`.`quantity` AS `available_quantity` from ((((`sales_transactions` `st` join `transaction_items` `ti` on((`st`.`transaction_id` = `ti`.`transaction_id`))) join `productvariant` `pv` on((`ti`.`product_id` = `pv`.`variant_id`))) join `product` `p` on((`pv`.`product_id` = `p`.`product_id`))) join `size` `s` on((`s`.`size_id` = `pv`.`size_id`))) where (`st`.`transaction_date` between '2024-05-02' and '2024-10-15') group by `sale_year`,`sale_week`,`p`.`product_id`,`pv`.`variant_id`,`pv`.`size_id`,`pv`.`color` order by `sale_year`,`sale_week` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`swen3920`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `monthly_sales_view` AS select date_format(`st`.`transaction_date`,'%Y-%m') AS `sale_month`,`p`.`product_id` AS `product_id`,`p`.`name` AS `product_name`,`pv`.`variant_id` AS `variant_id`,`s`.`size` AS `size`,`pv`.`color` AS `color`,coalesce(sum(`ti`.`quantity`),0) AS `total_quantity_sold`,coalesce(sum((`ti`.`quantity` * `ti`.`price`)),0) AS `total_sales`,`pv`.`quantity` AS `available_quantity` from ((((`sales_transactions` `st` join `transaction_items` `ti` on((`st`.`transaction_id` = `ti`.`transaction_id`))) join `productvariant` `pv` on((`ti`.`product_id` = `pv`.`variant_id`))) join `product` `p` on((`pv`.`product_id` = `p`.`product_id`))) join `size` `s` on((`s`.`size_id` = `pv`.`size_id`))) where (`st`.`transaction_date` between '2024-05-02' and '2024-10-15') group by `sale_month`,`p`.`product_id`,`pv`.`variant_id`,`pv`.`size_id`,`pv`.`color` order by `sale_month` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
